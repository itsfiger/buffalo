;;; ------ C Grammar -----------
;;; Import from cgrammar.y. For license and reference see there.

(in-package #:buffalo)

(define-parser cparser
  ...
  (:terminals
   (:|;| := :|:| :? :|\|| :^ :> :< :% :/ :! :~ :- :+ :* :& :|,| :} :{ :|.| :]
    ...
    :extern :static :auto :register :inline :restrict :char :short :int :long
    :signed :unsigned :float :double :const :volatile :void :bool :complex
    :imaginary :struct :union :enum :ellipsis :case :default :if :else :switch
  ...
  (specifier_qualifier_list (type_specifier specifier_qualifier_list)
   (type_specifier) (type_qualifier specifier_qualifier_list) (type_qualifier))
  (struct_declarator_list (struct_declarator)
   (struct_declarator_list :|,| struct_declarator))
  (struct_declarator (declarator) (:|:| constant_expression)
   (declarator :|:| constant_expression))
  (enum_specifier (:enum :{ enumerator_list :})
   (:enum :identifier :{ enumerator_list :}) (:enum :{ enumerator_list :|,| :})
